...
class _LoginState extends State<Login>
{
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            child: Text("Loging To your Account",style: TextStyle(color: Colors.white),),),
            Form(
              key: _formKey,
              child: Column(
                children: [
            ...
            RaisedButton(onPressed: (){_passwordTextEdditingController.text.isNotEmpty&&_emailTextEdditingController.text.isNotEmpty
            ?loginUser()
            :showDialog(context: context,
            builder: (c){
              return ErrorAlertDialog(message: "Please write Email and Passwrd",);
            });},
              color: Colors.pink,
  ...
  void loginUser()async{
    ...
    await _auth.signInWithEmailAndPassword(email:_emailTextEdditingController.text.trim(),
        password: _passwordTextEdditingController.text.trim(),
    ).then((authUser){
